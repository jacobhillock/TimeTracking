        ...
        <div className="calendar-current-time-overlay" aria-hidden="true">
          ...
          >
            ...
            <div
              ...
              style={{
                top: currentTimeMode === "within" ? currentTimeLabelWithinTop : currentTimeLabelTop,
              }}
        ...
        <div className="calendar-modal-overlay">
          ...
          >
            ...
            <div className="modal-grid-row modal-grid-row-three">
              ...
              <div className="modal-field">
                ...
                <input
                  ...
                  onChange={(e) =>
                    onEditEntry({ ...editingEntry, startTime: e.target.value }, editingEntryDateKey)
                  }
                  tabIndex={1}
                />
              </div>
              <div className="modal-field">
                ...
                <input
                  ...
                  onChange={(e) =>
                    onEditEntry({ ...editingEntry, endTime: e.target.value }, editingEntryDateKey)
                  }
                  tabIndex={2}
                />
              </div>
            ...
            <div className="modal-grid-row modal-grid-row-three modal-grid-row-ticket">
              <div className="modal-field">
                ...
                <select
                  ...
                  onChange={(e) =>
                    onEditEntry({ ...editingEntry, client: e.target.value }, editingEntryDateKey)
                  }
                  tabIndex={3}
                >
              ...
              <div className="modal-field">
                ...
                <input
                  ...
                  onChange={(e) =>
                    onEditEntry({ ...editingEntry, ticket: e.target.value }, editingEntryDateKey)
                  }
                  tabIndex={4}
                />
              </div>
            ...
            <div className="modal-field">
              ...
              <div className="modal-helper-text">Hold Ctrl or Cmd to choose multiple tags.</div>
            </div>
              ...
              <label>
                <input
                  ...
                  onChange={(e) => {
                    ...
                    onEditEntry(
                      { ...editingEntry, disabled: e.target.checked },
                      editingEntryDateKey,
                    );
                  }}
                  tabIndex={8}
